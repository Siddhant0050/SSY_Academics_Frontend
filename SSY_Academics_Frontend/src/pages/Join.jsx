...
import { Mail, Lock, User, Eye, EyeOff, UserPlus, ArrowRight, Check } from 'lucide-react';
      ...
      <div className="max-w-[1000px] w-full bg-white shadow-udemy flex overflow-hidden border border-udemyBorder">
        ...
        <div className="hidden lg:flex w-1/2 bg-udemyDark p-12 flex-col justify-between text-white relative overflow-hidden">
          <div className="z-10">
            ...
            <h3 className="text-xl font-semibold mb-8">Start your professional transformation today.</h3>
            
            <ul className="space-y-6">
              <li className="flex items-center gap-4">
                <div className="bg-ssySuccess rounded-full p-1"><Check className="w-4 h-4 text-white" /></div>
                <span className="text-gray-300 text-sm">Access to 50+ Industry-Grade Projects</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-ssySuccess rounded-full p-1"><Check className="w-4 h-4 text-white" /></div>
                <span className="text-gray-300 text-sm">Priority Placement Support</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-ssySuccess rounded-full p-1"><Check className="w-4 h-4 text-white" /></div>
                <span className="text-gray-300 text-sm">Expert Mentorship from Siddhant Yadav</span>
              </li>
            </ul>
          </div>
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-udemyDark mb-2">Create Your Account</h1>
            <p className="text-udemyGray text-sm">Already have an account? <Link to="/login" className="text-udemyPurple font-bold hover:underline">Log in</Link></p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase text-udemyDark">Full Name</label>
            ...
            {/* Email */}
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase text-udemyDark">Email</label>
              <div className="relative">
            ...
            {/* Password */}
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase text-udemyDark">Password</label>
              <div className="relative">
            ...
            <div className="py-2">
               <label className="flex items-start gap-3 cursor-pointer group">
                <input type="checkbox" required className="mt-1 w-4 h-4 border-udemyDark rounded-none checked:bg-udemyDark" />
                <span className="text-[12px] text-udemyGray leading-tight">
                  I want to receive occasional emails with course recommendations and career tips.
                </span>
              </label>
            </div>
          ...
          <p className="mt-8 text-center text-[11px] text-gray-500 leading-relaxed">
            By signing up, you agree to our <span className="underline font-medium cursor-pointer">Terms of Use</span> and <span className="underline font-medium cursor-pointer">Privacy Policy</span>.
          </p>
        </div>
      </div>
    </div>
